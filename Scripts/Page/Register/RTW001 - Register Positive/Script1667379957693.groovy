...
WebUI.setText(findTestObject('Register/Page_Secondhand Store/Input Nama'), 'annisa')

WebUI.setText(findTestObject('Register/Page_Secondhand Store/Input Email'), 'annisadwi1999@gmail.com')

WebUI.setEncryptedText(findTestObject('Register/Page_Secondhand Store/Input Password'), 'OZJwUcl/ZGSbAGjfTIQ6vw==')
