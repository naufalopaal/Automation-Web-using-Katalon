...
WebUI.setText(findTestObject('Object Repository/Add Product/Page_Secondhand Store/input_Nama Produk_nm_produk'), 'Bola Basket')

WebUI.setText(findTestObject('Object Repository/Add Product/Page_Secondhand Store/input_Harga Produk_harga_produk'), '300000')
...
WebUI.setText(findTestObject('Object Repository/Add Product/Page_Secondhand Store/textarea_Perlengkapan Olahraga'), 'Perlengkapan Olahraga')
